...
// this feels better but the instruction was to use a loop
/* function removeX(xOrNot) {
  return xOrNot != "X";
}

console.log(hiddenMessage.filter(removeX)); */

function removeXAndEven(inputArray) {
  for (let i = 0; i < inputArray.length; i ++) {
    if (inputArray[i] != "X" && inputArray[i] % 2 != 0) { console.log(inputArray[i]); }
  }
}

removeXAndEven(hiddenMessage);
...
const hiddenCodeArray = [...hiddenCode];

removeXAndEven(hiddenCodeArray);